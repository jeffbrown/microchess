...
### Verification
From the workflow step `Deploy Cloud Run` copy out url `https://microchess-__________run.app` of the invoke endpoint:
```
Invoke endpoint:
https://microchess-__________run.app
```

Call the api endpoint:
```
curl https://microchess-__________run.app/microchess
```
